...
const STATS = [
  { icon: Users, value: "2,847", label: "Verified Responders", suffix: "+" },
  { icon: Mountain, value: "12", label: "Districts Covered", suffix: "" },
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <br />
            <span className="relative">
              <span className="text-primary italic">Western Ghats</span>
              <motion.span
                className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-primary to-transparent"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-foreground/50 max-w-3xl mx-auto mb-12 leading-relaxed"
          >
            Hyper-local resilience for landslide-prone zones. Connecting drone pilots, 
            heavy machinery operators, and medical professionals 
            <span className="text-primary font-medium"> before the roads are blocked</span>.
          </motion.p>
