...
export const translations = {
  ...
  ml: {
    ...
    hero: {
      ...
      stats: {
        responders: "സാക്ഷ്യപ്പെടുത്തിയ സന്നദ്ധപ്രവർത്തകർ",
        districts: "ഉൾപ്പെട്ട ജില്ലകൾ",
    ...
    volunteer: {
      ...
      sector: "മേഖലയിൽ",
      briefing: {
        show: "ടാക്റ്റിക്കൽ ബ്രീഫിംഗ് കാണുക",
        hide: "ടാക്റ്റിക്കൽ ബ്രീഫിംഗ് മറയ്ക്കുക"
      },
      interface: "വോളന്റിയർ ഇന്റർഫേസ് തുറക്കുക",
      exit: "പുറത്തുകടക്കുക",
      mission: {
